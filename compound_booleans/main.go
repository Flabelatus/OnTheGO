...
func main() {
	...
	for _, x := range employees {
		...
		if x.Age > 30 && x.Salary > 50000 {
			...
			fmt.Println("Either", x.Name, "makes less than 50000 or is udner 30")
		}
		...
		if x.Age > 30 || x.Salary > 50000 {
			...
			fmt.Println(x.Name, "makes less than 50000 and is udner 30")
		}

		if (x.Age > 30 || x.Salary < 50000) && x.FullTime {
			fmt.Println(x.Name, "matches the unclear criteria")
		}
	}
}
